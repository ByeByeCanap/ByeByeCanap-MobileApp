...
export default function UserFormsPage6() {
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <Text style={styles.h3}>Avec quel type de personnes souhaitez-vous partager une activité ?</Text>
        <Dropdown
        ...
        <Text style={styles.h3}>Quelles causes ou projets vous tiennent à cœur ? </Text>
        <Dropdown
          style={styles.dropdown}
          data={valuesOptions}
          labelField="label"
