...
export default function UserFormsPage({ navigation }) {
    ...
    const [filteredInterestCategories, setFilteredInterestCategories] =
        useState([]);
    ...
    return (
        <View style={styles.container}>
            ...
            <ScrollView contentContainerStyle={styles.content}>
                ...
                <Text style={styles.h3}>
                    Avec quel type de personnes souhaitez-vous partager une
                    activité ?
                </Text>
                <Dropdown
                    style={styles.dropdown}
                ...
                <Text style={styles.h3}>
                    Je veux des suggestions personnalisées d’activités ou de
                    groupes..
                </Text>
                <Dropdown
                    style={styles.dropdown}
